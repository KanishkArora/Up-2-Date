...
public class BusinessActivity extends AppCompatActivity implements   LoaderManager.LoaderCallbacks<List<Health>> {
    public static  String LOG_TAG = BusinessActivity.class.getName();
    Adapter mAdapter;
    private static final int EARTHQUAKE_LOADER_ID = 1;
    private static final String REQUEST_URL="https://saurav.tech/NewsAPI/top-headlines/category/business/in.json";
    ...
    public boolean onCreateOptionsMenu(Menu menu){
        ...
        MenuItem.OnActionExpandListener onActionExpandListener = new MenuItem.OnActionExpandListener() {
            ...
            public boolean onMenuItemActionExpand(MenuItem item) {
                Toast.makeText(BusinessActivity.this,"Search",Toast.LENGTH_SHORT);
                return true;
            }

            @Override
            public boolean onMenuItemActionCollapse(MenuItem item) {
                Toast.makeText(BusinessActivity.this,"Search Ended",Toast.LENGTH_SHORT);
                return true;
            }
        };
