...
public class HealthActivity extends AppCompatActivity implements  LoaderManager.LoaderCallbacks<List<Health>>{
    Adapter mAdapter;
    ...
    public boolean onCreateOptionsMenu(Menu menu){
        ...
        MenuItem.OnActionExpandListener onActionExpandListener = new MenuItem.OnActionExpandListener() {
            ...
            public boolean onMenuItemActionExpand(MenuItem item) {
                Toast.makeText(HealthActivity.this,"Search",Toast.LENGTH_SHORT);
                return true;
            }

            @Override
            public boolean onMenuItemActionCollapse(MenuItem item) {
                Toast.makeText(HealthActivity.this,"Search Ended",Toast.LENGTH_SHORT);
                return true;
            }
        };
