...
public class LifestyleActivity extends AppCompatActivity implements  LoaderManager.LoaderCallbacks<List<Health>>{
    Adapter mAdapter;
    private static final int EARTHQUAKE_LOADER_ID = 1;
    private static final String REQUEST_URL="https://saurav.tech/NewsAPI/top-headlines/category/health/in.json";
    public static  String LOG_TAG = LifestyleActivity.class.getName();
    ...
    public boolean onCreateOptionsMenu(Menu menu){
        ...
        MenuItem.OnActionExpandListener onActionExpandListener = new MenuItem.OnActionExpandListener() {
            ...
            public boolean onMenuItemActionExpand(MenuItem item) {
                Toast.makeText(LifestyleActivity.this,"Search",Toast.LENGTH_SHORT);
                return true;
            }

            @Override
            public boolean onMenuItemActionCollapse(MenuItem item) {
                Toast.makeText(LifestyleActivity.this,"Search Ended",Toast.LENGTH_SHORT);
                return true;
            }
        };
