...
public class SportsActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<Health>> {
Adapter mAdapter;
    private static final String LOG_TAG = HealthActivity.class.getName();
    private static final int EARTHQUAKE_LOADER_ID = 1;
    private static final String REQUEST_URL="https://saurav.tech/NewsAPI/top-headlines/category/sports/in.json";
    @Override
    ...
    public boolean onCreateOptionsMenu(Menu menu){
        ...
        MenuItem.OnActionExpandListener onActionExpandListener = new MenuItem.OnActionExpandListener() {
            ...
            public boolean onMenuItemActionExpand(MenuItem item) {
                Toast.makeText(SportsActivity.this,"Search",Toast.LENGTH_SHORT);
                return true;
            }

            @Override
            public boolean onMenuItemActionCollapse(MenuItem item) {
                Toast.makeText(SportsActivity.this,"Search Ended",Toast.LENGTH_SHORT);
                return true;
            }
        };
